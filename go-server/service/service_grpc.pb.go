...
type CalculatorClient interface {
	...
	Substract(ctx context.Context, in *Numbers, opts ...grpc.CallOption) (*Number, error)
	Divide(ctx context.Context, in *Numbers, opts ...grpc.CallOption) (*Number, error)
	Multiplication(ctx context.Context, in *Numbers, opts ...grpc.CallOption) (*Number, error)
}
...
func (c *calculatorClient) Substract(ctx context.Context, in *Numbers, opts ...grpc.CallOption) (*Number, error) {
	out := new(Number)
	err := c.cc.Invoke(ctx, "/Calculator/Substract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calculatorClient) Multiplication(ctx context.Context, in *Numbers, opts ...grpc.CallOption) (*Number, error) {
	out := new(Number)
	err := c.cc.Invoke(ctx, "/Calculator/Multiplication", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServer interface {
	...
	Substract(context.Context, *Numbers) (*Number, error)
	Divide(context.Context, *Numbers) (*Number, error)
	Multiplication(context.Context, *Numbers) (*Number, error)
...
func (UnimplementedCalculatorServer) Substract(context.Context, *Numbers) (*Number, error) {
...
func (UnimplementedCalculatorServer) Multiplication(context.Context, *Numbers) (*Number, error) {
...
func _Calculator_Substract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Calculator/Substract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Substract(ctx, req.(*Numbers))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Calculator_Multiplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Calculator/Multiplication",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Multiplication(ctx, req.(*Numbers))
	}
	return interceptor(ctx, in, info, handler)
}
